...
globalkeys = gears.table.join(
	...
	awful.key({ altkey, }, "l", function() awful.spawn("alacritty -e lfrun") end,
	...
	awful.key({ modkey }, "d",
		function() awful.util.spawn("rofi -no-lazy-grab -show drun -modi run,drun,window -theme ~/.config/rofi/launchers/colorful/style_7.rasi") end
		,
		{ description = "launch dmenu", group = "launcher" }),

	awful.key({ modkey }, "b", function() awful.util.spawn("polybar-msg cmd toggle") end,
		{ description = "launch dmenu", group = "launcher" }),


	awful.key({ modkey }, "o", function() awful.util.spawn('google-chrome-stable') end,
		{ description = "launch chromium", group = "launcher" }),


	awful.key({ modkey }, "r", function() awful.util.spawn('bash rcnt.sh') end,
		{ description = "reconnect realme", group = "launcher" }),

	awful.key({ modkey, "shift" }, "e", function() awful.util.spawn('emacsclient -c -a "emacs"') end,
		{ description = "launch emacs", group = "launcher" }),

	awful.key({ modkey, }, "k", awful.client.movetoscreen),
